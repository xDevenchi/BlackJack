...
#GAME STARTS
while True:
    print("Welcome to Luigi's Blackjack game! It is an easy game, but hard to master! \n\
          Aim to get close to 21 without going above 21!") #prints welcome message to player
